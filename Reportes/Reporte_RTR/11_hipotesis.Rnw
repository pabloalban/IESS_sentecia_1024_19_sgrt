...
La reserva inicial del \Sexpr{REP_seg} empleada para el cálculo de la reserva en términos corrientes, $V_t^{cap}$ (ver ecuación \ref{eq:balance}), y la reserva en valor presente, $V_t$ (ver ecuación \ref{eq:balance_act}), corresponde al patrimonio al 31 de diciembre de 2021 (ver tabla \ref{tab:iess_patrimonio_fondo_rtr}), el cual asciende a USD \Sexpr{REP$cap_ini}.
...
variación, período 2022 a 2061, el detalle de los cálculos se encuentra en el capítulo \ref{chp_contexto}. 
 ...
 \begin{table}[H]
 \centering
 \caption{Resumen de hipótesis macroeconómicas}
