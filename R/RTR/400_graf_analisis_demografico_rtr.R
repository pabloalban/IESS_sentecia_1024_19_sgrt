...
ggsave( plot = iess_pir_ben_subsidios, 
        filename = paste0( parametros$resultado_graficos, 'iess_pir_ben_subsidios', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )
...
ggsave( plot = iess_pir_ben_indemnizaciones, 
        filename = paste0( parametros$resultado_graficos, 'iess_pir_ben_indemnizaciones', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )
